...
function checkIsoDateInBounds(e2) {
  return checkIsoDateTimeInBounds(__spreadProps(__spreadValues(__spreadValues({}, e2), Nt), {
    isoHour: 12
  })), e2;
}
function checkIsoDateTimeInBounds(e2) {
  const n2 = clampProp(e2, "isoYear", wr, Fr, 1), t2 = n2 === wr ? 1 : n2 === Fr ? -1 : 0;
  return t2 && checkEpochNanoInBounds(isoToEpochNano(__spreadProps(__spreadValues({}, e2), {
    isoDay: e2.isoDay + t2,
...
function isoToEpochNanoWithOffset(e2, n2) {
  ...
  return checkEpochNanoInBounds(isoToEpochNano(__spreadValues(__spreadProps(__spreadValues({}, e2), {
    isoDay: e2.isoDay + o2
  }), t2)));
}
...
function clampRelativeDuration(e2, n2, t2, o2, r2, i2, a2) {
  const s2 = p[t2], c2 = __spreadProps(__spreadValues({}, n2), {
    [s2]: n2[s2] + o2
...
function roundDateTimeToNano(e2, n2, t2) {
  ...
  return checkIsoDateTimeInBounds(__spreadValues(__spreadValues({}, moveByDays(e2, r2)), o2));
}
...
function nudgeDayTimeDuration(e2, n2, t2, o2, r2, i2) {
  ...
  return [__spreadValues(__spreadValues({}, e2), l2), addBigNanos(n2, u2), f2];
}
function nudgeZonedTimeDuration(e2, n2, t2, o2, r2, i2, a2, s2, c2, u2) {
  ...
  const [p2, h2] = clampRelativeDuration(a2, __spreadValues(__spreadValues({}, e2), hr), 6, f2, s2, c2, u2), g2 = m2 - bigNanoToNumber(diffBigNanos(p2, h2));
  let D2 = 0;
  ...
  return [__spreadProps(__spreadValues(__spreadValues({}, e2), T2), {
    days: e2.days + D2
  }), n2, Boolean(D2)];
}
...
function pe(e2, n2, t2, o2, r2, i2 = /* @__PURE__ */ Object.create(null)) {
  ...
  return __spreadValues(__spreadValues({}, o2), moveZonedEpochs(a2, s2, o2, t2 ? negateDurationFields(r2) : r2, i2));
}
...
function Gt(e2, n2, t2, o2, r2) {
  ...
  n2 && (o2 = B(o2)), o2.sign < 0 && (s2 = a2.P(s2, __spreadProps(__spreadValues({}, pr), {
    months: 1
  })), s2 = moveByDays(s2, -1));
...
function moveZonedEpochs(e2, n2, t2, o2, r2) {
  ...
  if (durationHasDateParts(o2)) {
    const s2 = he(t2, e2);
    a2 = addBigNanos(getSingleInstantFor(e2, __spreadValues(__spreadValues({}, moveDate(n2, s2, __spreadValues(__spreadValues({}, o2), hr), r2)), nn(w, s2))), i2);
  } else {
...
function moveDateTime(e2, n2, t2, o2) {
  ...
  return checkIsoDateTimeInBounds(__spreadValues(__spreadValues({}, moveDate(e2, n2, __spreadProps(__spreadValues(__spreadValues({}, t2), hr), {
    days: t2.days + i2
  }), o2)), r2));
}
...
function moveByDays(e2, n2) {
  return n2 ? __spreadValues(__spreadValues({}, e2), epochMilliToIso(isoToEpochMilli(e2) + n2 * ko)) : e2;
}
function createMarkerSystem(e2, n2, t2) {
  const o2 = e2(t2.calendar);
  return isZonedEpochSlots(t2) ? [t2, o2, n2(t2.timeZone)] : [__spreadValues(__spreadValues({}, t2), Nt), o2];
}
...
function E(e2, n2, t2, o2, r2, i2, a2) {
  ...
  if (isUniformUnit(c2, s2)) {
    return Oe(checkDurationUnits(((e3, n3, t3, o3) => {
      ...
      return __spreadValues(__spreadValues({}, pr), nanoToDurationDayTimeFields(r3, t3));
    })(r2, i2, c2, o2)));
  }
  if (!s2) {
    throw new RangeError(yo);
...
function V(e2, n2, t2, o2, r2) {
  ...
  if (!f2 && l2 <= 6) {
    return Oe(checkDurationUnits(((e3, n3, t3, o3, r3) => {
      ...
      return __spreadValues(__spreadValues({}, pr), nanoToDurationDayTimeFields(i3, n3));
    })(o2, a2, s2, c2, u2)));
  }
...
function de(e2, n2, t2) {
  ...
  return n2 ? o2.calendar === l && (o2 = -271821 === o2.isoYear && 4 === o2.isoMonth ? __spreadValues(__spreadProps(__spreadValues({}, o2), {
    isoDay: 20
  }), Nt) : __spreadValues(__spreadProps(__spreadValues({}, o2), {
    isoDay: 1
  }), Nt)) : t2 && o2.calendar === l && (o2 = __spreadProps(__spreadValues({}, o2), {
    isoYear: Br
...
function R(e2) {
  const n2 = ((e3) => {
    ...
    return n3 ? ((e4) => {
      ...
      let n4 = 0, t2 = 0, o2 = 0, r2 = __spreadValues(__spreadValues({}, zipProps(p, [parseUnit(e4[2]), parseUnit(e4[3]), parseUnit(e4[4]), parseUnit(e4[5]), parseUnit(e4[6], e4[7], 5), parseUnit(e4[8], e4[9], 4), parseUnit(e4[10], e4[11], 3)])), nanoToGivenFields(o2, 2, p));
      if (!n4) {
...
function it(e2, n2, t2, o2) {
  const [r2, i2, a2, s2] = refineDiffOptions(e2, o2, 5, 5), c2 = roundByInc(diffTimes(n2, t2), computeNanoInc(i2, a2), s2), u2 = __spreadValues(__spreadValues({}, pr), nanoToDurationTimeFields(c2, r2));
...
function diffZonedEpochsBig(e2, n2, t2, o2, r2, i2, a2) {
  const [s2, c2, u2] = ((e3, n3, t3, o3) => {
    function updateMid() {
      return f3 = __spreadValues(__spreadValues({}, moveByDays(a3, c3++ * -o3)), i3), l3 = getSingleInstantFor(e3, f3), compareBigNanos(s3, l3) === -o3;
    }
  ...
  var f2, l2;
  return __spreadValues(__spreadValues({}, 6 === i2 ? (f2 = s2, l2 = c2, __spreadProps(__spreadValues({}, pr), {
    days: diffDays(f2, l2)
  })) : e2.N(s2, c2, i2, a2)), nanoToDurationTimeFields(u2));
}
function diffDateTimesBig(e2, n2, t2, o2, r2, i2) {
  ...
  return __spreadValues(__spreadValues({}, e2.N(a2, s2, r2, i2)), nanoToDurationTimeFields(c2));
}
function diffEpochNanos(e2, n2, t2, o2, r2, i2) {
  return __spreadValues(__spreadValues({}, pr), nanoToDurationDayTimeFields(roundBigNano(diffBigNanos(e2, n2), o2, r2, i2), t2));
}
function diffEpochNanosExact(e2, n2, t2) {
  return __spreadValues(__spreadValues({}, pr), nanoToDurationDayTimeFields(diffBigNanos(e2, n2), t2));
}
...
function $(e2, n2, t2, o2) {
  ...
  return __spreadValues(__spreadValues({}, t2.F(r2)), Nt);
}
function Ne(e2, n2, t2, o2, r2, i2) {
  ...
  return _e(getMatchingInstantFor(n2(s2), __spreadValues(__spreadValues({}, l2), d2), void 0 !== a2.offset ? parseOffsetNano(a2.offset) : void 0, u2, f2), s2, o2);
}
function At(e2, n2, t2) {
  const o2 = refineCalendarFields(e2, n2, Xo, [], O), r2 = mt(t2);
  return jt(checkIsoDateTimeInBounds(__spreadValues(__spreadValues({}, e2.F(o2, fabricateOverflowOptions(r2))), refineTimeBag(o2, r2))));
}
...
function q(e2) {
  ...
  return Oe(checkDurationUnits(__spreadValues(__spreadValues({}, pr), n2)));
}
...
function refineTimeBag(e2, n2) {
  return constrainIsoTimeFields(xi(__spreadValues(__spreadValues({}, tr), e2)), n2);
}
function De(e2, n2, t2, o2, r2) {
  const { calendar: i2, timeZone: a2 } = t2, s2 = e2(i2), c2 = n2(a2), u2 = [...s2.fields(Xo), ...Lo].sort(), f2 = ((e3) => {
    ...
    return __spreadProps(__spreadValues({}, $i(n3)), {
      year: r3,
      monthCode: u3,
      day: a3,
      offset: t3
    });
  })(t2), l2 = refineFields(o2, u2), d2 = s2.k(f2, l2), m2 = __spreadValues(__spreadValues({}, f2), l2), [p2, h2, g2] = je(r2, 2);
  return _e(getMatchingInstantFor(c2, __spreadValues(__spreadValues({}, s2.F(d2, fabricateOverflowOptions(p2))), constrainIsoTimeFields(xi(m2), p2)), parseOffsetNano(m2.offset), h2, g2), a2, i2);
}
function gt(e2, n2, t2, o2) {
  const r2 = e2(n2.calendar), i2 = [...r2.fields(Xo), ...O].sort(), a2 = __spreadProps(__spreadValues({}, computeDateEssentials(s2 = n2)), {
    hour: s2.isoHour,
    minute: s2.isoMinute,
    second: s2.isoSecond,
  ...
  var s2;
  const c2 = refineFields(t2, i2), u2 = mt(o2), f2 = r2.k(a2, c2), l2 = __spreadValues(__spreadValues({}, a2), c2);
  return jt(checkIsoDateTimeInBounds(__spreadValues(__spreadValues({}, r2.F(f2, fabricateOverflowOptions(u2))), constrainIsoTimeFields(xi(l2), u2))));
}
function ee(e2, n2, t2, o2) {
...
function rt(e2, n2, t2) {
  return St(((e3, n3, t3) => refineTimeBag(__spreadValues(__spreadValues({}, nn(qo, e3)), refineFields(n3, qo)), mt(t3)))(e2, n2, t2));
}
function A(e2, n2) {
  return Oe((t2 = e2, o2 = n2, checkDurationUnits(__spreadValues(__spreadValues({}, t2), refineFields(o2, ur)))));
  var t2, o2;
}
...
function ae(e2, n2, t2, o2, r2) {
  ...
  let u2;
  return u2 = s2 ? getSingleInstantFor(c2, __spreadValues(__spreadValues({}, o2), s2)) : getStartOfDayInstantFor(c2, __spreadValues(__spreadValues({}, o2), Nt)), _e(u2, i2, o2.calendar);
}
function ie(e2, n2 = Nt) {
  return jt(checkIsoDateTimeInBounds(__spreadValues(__spreadValues({}, e2), n2)));
}
...
function ge(e2, n2, t2) {
  const o2 = n2.timeZone, r2 = e2(o2), i2 = __spreadValues(__spreadValues({}, he(n2, r2)), t2 || Nt);
  let a2;
...
var FixedTimeZone = class {
  ...
  I(e2) {
    return ((e3) => {
      const n2 = isoToEpochNano(__spreadValues(__spreadValues({}, e3), Nt));
...
var Yi = {
  ...
  N(e2, n2, t2) {
    if (t2 <= 7) {
      let o3 = 0, r3 = diffDays(__spreadValues(__spreadValues({}, e2), Nt), __spreadValues(__spreadValues({}, n2), Nt));
      return 7 === t2 && ([o3, r3] = divModTrunc(r3, 7)), __spreadProps(__spreadValues({}, pr), {
        weeks: o3,
        days: r3
      });
    }
    ...
    return 8 === t2 && (a2 += this.cn(i2, o2[0]), i2 = 0), __spreadProps(__spreadValues({}, pr), {
      years: i2,
      months: a2,
      days: s2
    });
...
var Li = __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, {
...
}), wo(O, toInteger)), wo(p, toStrictInteger)), {
  offset(e2) {
    const n2 = toStringViaPrimitive(e2);
...
function refinePublicRelativeTo(t2) {
  if (void 0 !== t2) {
    if (s(t2)) {
      ...
      return __spreadProps(__spreadValues({}, $(refineTimeZoneArg, L, C(n2), t2)), {
        calendar: n2
      });
    }
    return H(t2);
  ...
  if (s(t2)) {
    ...
    switch (n3.branding) {
      case x:
        return mt(e2), n3;
      case G:
        return mt(e2), jt(__spreadValues(__spreadValues({}, n3), Nt));
      case z:
...
var hn = createCalendarGetters(__spreadValues(__spreadValues({}, fn), mn));
var Dn = createCalendarGetters(__spreadValues(__spreadValues({}, mn), dn));
var Pn = {
...
var [wn, In, vn] = createSlotClass(N, j, __spreadProps(__spreadValues({}, gn), {
  blank: y
}), {
...
var [Yn, En] = createSlotClass(x, Pt(Zt, Mt), __spreadValues(__spreadValues(__spreadValues({}, Pn), Tn), pn), {
...
var [Ln, Vn, Jn] = createSlotClass(qt, Pt(kt, Mt), __spreadValues(__spreadValues({}, Pn), Dn), {
...
var [kn, qn, Rn] = createSlotClass(Ut, Pt(Qt, Mt), __spreadValues(__spreadValues({}, Pn), hn), {
...
var [xn, Wn, Gn] = createSlotClass(G, Pt(ue, Mt), __spreadValues(__spreadValues({}, Pn), Tn), {
...
var [zn, $n] = createSlotClass(z, Pt(ye, Mt, Ze), __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, On), Pn), adaptDateMethods(Tn)), adaptDateMethods(pn)), {
  ...
  getTimeZoneTransition(t2, e2) {
    ...
    return a2 ? $n(__spreadProps(__spreadValues({}, t2), {
      epochNanoseconds: a2
    })) : null;
  }
}, {
...
var Un = Object.defineProperties({}, __spreadValues(__spreadValues({}, o("Temporal.Now")), n({
  timeZoneId: () => Ue(),
  instant: () => Kn(xe(Xe())),
...
var Xn = Object.defineProperties({}, __spreadValues(__spreadValues({}, o("Temporal")), n({
  PlainYearMonth: kn,
  PlainMonthDay: Ln,
  PlainDate: xn,
  PlainTime: An,
...
//# sourceMappingURL=chunk-BVQWMVQ7.js.map
